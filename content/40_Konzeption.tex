...
\todo{\cite[S.~45--52]{SpillnerLinz2022} -- Risikobasiertes Testen (Teststrategie) einarbeiten}
\todo{\cite[S.~110--118]{SpillnerLinz2022} -- Testinfrastruktur-Anforderungen (Testumgebung) einarbeiten}

\section{Zwei-Phasen-Rollout-Konzept (lokal zu zentralisiert)}
...
Das Konzept orientiert sich an den in \autoref{chap:ist-analyse-anforderungen} beschriebenen Anforderungen und priorisiert zunächst lokal beherrschbare, reproduzierbare Testläufe.
